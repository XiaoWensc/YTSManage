...
public class PhotoTools {
    ...
    public static List<PhotoFolderInfo> getAllPhotoFolder(Context context, List<PhotoInfo> selectPhotoMap) {
        ...
        ImageFilter imageFilter  = GalleryFinal.getFunctionConfig().getImageFilter();
        try {
            ...
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    if ( (imageFilter != null && imageFilter.filter(path)) && (filterList == null || !filterList.contains(path)) && file.exists() && file.length() > 0 ) {
