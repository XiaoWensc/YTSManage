...
public final class ToolLog {
    ...
    public static class Builder {
        public Builder() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && YTApplication.get().getApplicationContext().getExternalCacheDir() != null)
                defaultDir = YTApplication.get().getApplicationContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = YTApplication.get().getApplicationContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }

        public Builder setLogSwitch(boolean logSwitch) {
            ToolLog.sLogSwitch = logSwitch;
            return this;
        }
        ...
        public Builder setLogHeadSwitch(boolean logHeadSwitch) {
            ToolLog.sLogHeadSwitch = logHeadSwitch;
            return this;
        }

        public Builder setLog2FileSwitch(boolean log2FileSwitch) {
            ToolLog.sLog2FileSwitch = log2FileSwitch;
            return this;
        }
        ...
        public Builder setDir(final String dir) {
            if (isSpace(dir)) {
                ...
                ToolLog.dir = dir.endsWith(FILE_SEP) ? dir : dir + FILE_SEP;
            }
            return this;
        }

        public Builder setDir(final File dir) {
            ToolLog.dir = dir == null ? null : dir.getAbsolutePath() + FILE_SEP;
            return this;
        }

        public Builder setBorderSwitch(boolean borderSwitch) {
            ToolLog.sLogBorderSwitch = borderSwitch;
            return this;
        }

        public Builder setLogFilter(@TYPE int logFilter) {
            ToolLog.sLogFilter = logFilter;
            return this;
        }
    ...
    private static void printHttpLog(int type, String tag, String msg,String http) {
