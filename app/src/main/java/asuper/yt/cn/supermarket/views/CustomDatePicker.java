...
public class CustomDatePicker {
    ...
    public CustomDatePicker(Context context, ResultHandler resultHandler, String startDate, String endDate,boolean isRetTime) {
        if (isValidDate(startDate, "yyyy-MM-dd HH:mm") && isValidDate(endDate, "yyyy-MM-dd HH:mm")) {
            this.isRestTime = isRetTime;
            canAccess = true;
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isRestTime) {
                    ...
                    handler.handle(sdf.format(selectedCalender.getTime()).split(" ")[0]);
                }
                datePickerDialog.dismiss();
            }
        });
