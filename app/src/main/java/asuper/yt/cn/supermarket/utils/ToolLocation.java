...
public class ToolLocation {
    ...
    public static LocationClient mLocClient = new LocationClient(YTApplication.get());
    ...
    public static boolean isGpsOPen() {
        LocationManager locationManager = (LocationManager) YTApplication.get().getSystemService(Context.LOCATION_SERVICE);
    ...
    private static LocationClientOption configOptions() {
        ...
        if (isGpsOPen()) {
            ...
            if (ToolNetwork.getInstance().init(YTApplication.get())
                    .isConnected()) {
